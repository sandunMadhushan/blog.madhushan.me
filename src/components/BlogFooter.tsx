          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-4">
                Sandun{" "}
                <span className="portfolio-text-gradient">Madhushan</span>
              </h3>
              <p className="text-muted-foreground text-lg leading-relaxed max-w-md">
                Full-Stack Developer passionate about creating beautiful digital
                experiences and sharing knowledge through code and storytelling.
              </p>
            </div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-foreground portfolio-transition flex items-center gap-2 group"
                >
                  <span>Home</span>
              ...
              <li>
                <a
                  href="https://madhushan.me/#projects"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-foreground portfolio-transition flex items-center gap-2 group"
                >
              ...
              <li>
                <a
                  href="https://madhushan.me/#contact"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-foreground portfolio-transition flex items-center gap-2 group"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-muted-foreground hover:text-yellow-400 portfolio-transition"
                >
                  Web Development
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-muted-foreground hover:text-blue-400 portfolio-transition"
                >
                  Mobile Apps
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-muted-foreground hover:text-purple-400 portfolio-transition"
                >
                  AI & Machine Learning
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-muted-foreground hover:text-green-400 portfolio-transition"
                >
                  Career Advice
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-muted-foreground hover:text-pink-400 portfolio-transition"
                >
                  Personal Growth
                </a>
              </li>
        ...
        <div className="border-t border-border/50 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-muted-foreground">
              <span>
                &copy; {currentYear} Sandun Madhushan. All rights reserved.
              </span>
            </div>
