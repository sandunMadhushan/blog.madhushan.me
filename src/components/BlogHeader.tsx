...
const BlogHeader = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 portfolio-transition ${
      isScrolled 
      ...
      <div className="container mx-auto px-6 py-4">
        <nav className="flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <a href="/" className="text-2xl font-bold text-foreground hover:text-yellow-400 portfolio-transition">
              Sandun Madhushan
            </a>
